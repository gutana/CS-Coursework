...
public:
	...
	// TODO: Should maybe allow different offsets/repeats for the different textures
	...
	void render(TerrainType type, bool renderNormalsAroundPlayer, const Vector3& pos, double radius)
	{
		...
		if(renderNormalsAroundPlayer)
			hMapUnderWater.drawNormalsGlobal(100, m_Scale);
